...
export const productList: IProduct[] = [
    {
        ...
        cost: 24780.00,
        image: img1,
        description: `Тип корпуса: Ovation
Верхняя дека: ель
...
`
    },
    {
        ...
        cost: 51000.00,
        image: img5,
        description: `88 клавиш с молоточковой механикой (Scaled Hammer Action Keyboard II)
...
В комплекте: педаль SP-3, пюпитр и сетевой адаптер AD-A12150LW`
    },
    {
        ...
        cost: 14280.00,
        image: img6,
        description: `Тип корпуса: Дредноут с вырезом
Верхняя дека: Ель
